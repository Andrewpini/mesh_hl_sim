...
class MeshNode(object):
	...
	def start_dfu(self, n_bytes):
		...
		self.nxt_adv_packet = self.adv_queue.pop(0)
...
# a.start_dfu(150000)
# # print(a.adv_queue)
# # a.adv_queue.extend([0,1,2,3])
# # for item in range(0,400000,25):
# # 	a.advertise_nxt_message(item)
